# Miss Lana's Fairy-Tale Theatre — website

Сайт выездного детского **живого костюмированного театра сказок** (Лос-Анджелес,
30+ лет опыта), зонтик-бренд **Miss Lana**, live primary domain `misslanatheatre.com`.
Цель сайта —
...
> Бренд не ассоциируем с Россией. Канон бренда/домена/контактов —
> [docs/core/BRAND.md](docs/core/BRAND.md) (LOCK). Primary contact:
> `info@misslanatheatre.com`, **(323) 903-2039**; SMS/email/WhatsApp accepted.
...
- ✅ Discovery, канон (`docs/core/`), ребрендинг/домен/contact sync, ресёрч.
